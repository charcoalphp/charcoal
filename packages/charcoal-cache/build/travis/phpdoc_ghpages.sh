...
## From https://rootslabs.net/blog/511-publier-automatiquement-phpdoc-github-travis-ci
...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-cache" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo -e ">>> https://$GH_PAGES/docs/$TRAVIS_BRANCH/ \n"
