...
trait CollectionContainerTrait
{
     ...
     * @return CollectionContainerInterface Chainable
     */
    public function setCollectionConfig($config, $trusted = false): CollectionContainerInterface
    {
     ...
     * @return self
     */
    public function mergeCollectionConfig(array $config, $trusted = false): static
    {
        if ($this->collectionConfig === null) {
     ...
     * @return array
     */
    protected function parseCollectionConfig(array $config, $trusted = false): array
    {
