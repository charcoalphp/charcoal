...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-email" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "7.2" ]; then
    ...
    echo -e ">>> http://locomotivemtl.github.io/charcoal-email/apigen/$TRAVIS_BRANCH/ \n"
fi
