...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-property" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo -e ">>> http://locomotivemtl.github.io/charcoal-property/apigen/$TRAVIS_BRANCH/ \n"
fi
